...
def get_labeled_image(labeled_image_path, pairs, plot=False, verbal=False):
    if verbal:
...
def pairs_in_spectral_curves(ideal_dataloader, file_name, pairing_obj, verbal=False):
    if verbal:
