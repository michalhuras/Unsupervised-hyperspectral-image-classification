...
def clustering_kmeans(the_image, my_net, img_shape, img_dir, img_name, number_of_clusters, show_image=False):
    # From indian pines
    # TODO - ujednolicić!
    # print()
    ...
    print("Number of claters: ", number_of_clusters)
    kmeans = KMeans(n_clusters=number_of_clusters).fit(df)

    print("Creating list for clastered data")
    clastered_data = np.zeros(img_shape)
